...
# استبدال argparse بتحديد المعاملات فقط إذا لم يكن الكود يتم تشغيله بواسطة gunicorn
...
if 'gunicorn' not in sys.argv[0] and args.profile:
...
# يجب استخدام gunicorn لتشغيل التطبيق
